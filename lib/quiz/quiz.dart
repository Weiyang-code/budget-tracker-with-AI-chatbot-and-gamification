...
import 'package:budgettracker/quiz/quiz_state.dart';
import 'package:budgettracker/shared/shared.dart';
import 'package:budgettracker/shared/progress_bar.dart';
      ...
      child: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.hasError) {
            ...
            return Scaffold(
              appBar: AppBar(
                title: AnimatedProgressBar(value: state.progress, height: 15),
                leading: IconButton(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Congrats! You completed the ${quiz.title}',
